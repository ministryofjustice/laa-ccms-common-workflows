...
| `image_scan_db_update`      | Whether to update the database for image scanning.         | false    | `true`                               |
| `image_scan_java_db_update` | Whether to update the java database image scanning.        | false    | `true`                               |
